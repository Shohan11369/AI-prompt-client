...
export default async function HomepageDynamicTestimonials() {
  ...
  if (reviews.length === 0) {
    return (
      <div className="py-16 px-6 max-w-6xl mx-auto text-center">
        <h2 className="text-3xl font-bold text-brand-text mb-4">Client Testimonials</h2>
  ...
  return (
    <div className="py-16 px-6 max-w-6xl mx-auto">
      <h2 className="text-3xl font-bold text-brand-text text-center mb-10">Client Testimonials</h2>
