...
const MOCK_ORGS = [
  {
    ...
    description:
      "Hosting global developer conferences and software hacking marathons.",
  ...
  },
  {
    ...
    description:
      "Premium concerts, electronic dance music festivals and outdoor events.",
  ...
  },
  {
    ...
    description:
      "Bringing world-class chefs together for exclusive food festivals.",
...
export default function TopOrganizers({ featuredOrgs = MOCK_ORGS }) {
  const orgs =
    featuredOrgs && featuredOrgs.length > 0 ? featuredOrgs : MOCK_ORGS;
  return (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-xl mx-auto text-sm mt-3">
            Powering the community. Meet the featured organizations behind the
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {orgs.map((org) => (
            <div key={org._id}>
              <Card
                className="bg-slate-900/50 border border-white/5 backdrop-blur-xl hover:border-pink-500/30 transition-all duration-300 p-6 flex flex-col items-center text-center h-full gap-4"
                radius="lg"
              >
                <Image
                  width={80}
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-slate-400 text-xs line-clamp-3 leading-relaxed mt-2">
                    {org.description ||
                      "Leading organizer hosting curated community meetups and large music experiences."}
                  </p>
                </div>
                {org.website && (
                  <Button
