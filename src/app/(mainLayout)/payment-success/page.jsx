      ...
      <Card className="w-full max-w-lg border border-white/5 bg-slate-950/70 backdrop-blur-xl shadow-2xl p-4">
        <>
          <CardHeader className="flex flex-col gap-1 items-center pb-6 text-center">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight bg-linear-to-r from-white via-slate-100 to-green-400 bg-clip-text text-transparent">
              Payment Successful!
            </h1>
          ...
          <div className="gap-6 bg-slate-900/40 p-6 rounded-2xl border border-white/5">
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-xs text-slate-400">
                ...
                <span className="text-indigo-400 font-semibold truncate max-w-50">
          ...
          <CardFooter className="flex flex-col sm:flex-row gap-3 pt-8 justify-center">
            <Link href="/dashboard/attendee/tickets">
              <Button
                ...
                className="w-full sm:w-auto bg-linear-to-r from-pink-500 to-indigo-600 text-white font-bold h-11 px-6 shadow-lg shadow-pink-500/10 hover:shadow-pink-500/20"
                radius="lg"
